...
public sealed partial class PlayerVariables
{
    ...
    public sealed class NewMovementVars : MonoBehaviour
    {
        ...
        [HideInInspector] public bool modNoJump;

        [HideInInspector] public float modForcedFrictionMultip = 1f;

        public float friction;

        public InputManager inman;

        [HideInInspector] public AssistController asscon;
        ...
        [HideInInspector] public float longestSlide;
        ...
        [HideInInspector] public float safeExplosionLaunchCooldown;
        ...
        [HideInInspector] public float slamCooldown;

        public bool launched;

        public int difficulty;

        [HideInInspector] public int sameCheckpointRestarts;

        public CustomGroundProperties groundProperties;

        [HideInInspector] public int rocketJumps;

        [HideInInspector] public int hammerJumps;

        [HideInInspector] public Grenade ridingRocket;

        [HideInInspector] public int rocketRides;
        ...
        [HideInInspector] public HashSet<Water> touchingWaters = new();
