...
namespace ULTRAPRACTICE.Classes
{
    ...
    public class NewMovementVars : MonoBehaviour
    {
    ...
    public static class playerVariables
    {
        ...
        public static IEnumerator SetVelocityAfter(NewMovement ply)
        {
            ...
            if (ply.jumping)
            {
                ply.Invoke("JumpReady", timeUntilJumpReadyMax - timeUntilJumpReady);
                ply.Invoke("NotJumping", timeUntilNotJumpingMax - timeUntilNotJumping);
            }
            ply.gc.StopForceOff();
        }
    }
