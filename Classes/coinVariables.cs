...
namespace ULTRAPRACTICE.Classes
{
    ...
    /// </summary>
    public class CoinTimers : MonoBehaviour
    {
    ...
    public static class coinVariables
    {
        ...
        public static void SaveVariables()
        {
            ...
            for (int i = 0; i < allObjs.Length; i++)
            {
                ...
                states[i].invokingDeletion = allObjs[i].IsInvoking("GetDeleted");
                states[i].invokingTripleTime = allObjs[i].IsInvoking("TripleTime");
                states[i].invokingDoubleTime = allObjs[i].IsInvoking("DoubleTime");
                states[i].invokingTripleTimeEnd = allObjs[i].IsInvoking("TripleTimeEnd");
                states[i].invokingCheckingSpeed = allObjs[i].IsInvoking("StartCheckingSpeed");
